...
const PaymentOption = ({radioSelect, setRadioSelect, radio1Ref, radio2Ref}) => {
              ...
              <div className="flex flex-col gap-3">
                <div
                  className={`rounded-xl ${
                    radioSelect === 'Pay in full' ? 'bg-039D9D text-white' : 'border'
                  }`}
                ...
                <div
                  className={`rounded-xl ${
                    radioSelect === 'Pay part now, part later' ? 'bg-039D9D text-white' : 'border'
                  }`}
